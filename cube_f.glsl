...
uniform vec3 objectColor; // Uniform to receive the color
out vec4 FragColor;
...
void main(void)
{
	...
	// scale the color by the object color
	FragColor = vec4(objectColor * (diffuseColor + specularColor + ambientColor + 0.25), 1);
	// shinier version
