...
vec3 kd = vec3(0.5, 0.5, 0.3);     // diffuse reflectance coefficient (more red and green, less blue)
vec3 ka = vec3(0.5, 0.5, 0.1); // ambient reflectance coefficient (more red and green, less blue)
